...
## 3. 2026-08-19 ????cloak_fire_burst_anim v2?

- ???BiRefNet ?????????????????????????????????????????
- ?????? alpha?`gen_20260819_anim/remat_luma.py`??a_lin=(max??-??)/(255-??)?gamma 0.8 ?????RGB ?? straight alpha?bleed 24?
- ???????? 53?72% ? ?? 82?88%????????? slot10 ???? ???? ? 0%?
- ????????2000?2000 / 5?5 / cell 400 / content 384 / gutter 8 / fps 4.8387???? cloak_flipbook?final?GameProject/assets/vfx ???
- ?????`ArtAsset/Image/VFX/gen_20260819_anim/`?remat_luma.py?pipeline_manifest.json?PROCESS_REPORT.md????? .gitignore ?????
