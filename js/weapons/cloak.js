...
export const CARD = {
  ...
  levels: [
    { damage: 5, radius: 110 },
    { damage: 7, radius: 128, burn: true, burnDps: 10 },
    { damage: 10, radius: 146, burn: true, burnDps: 12 },
    { damage: 12, radius: 165, burn: true, burnDps: 14, shock: true, shockCd: 5.5, shockTicks: 6, shockRadiusMult: 1.7 },
    { damage: 15, radius: 185, burn: true, burnDps: 16, shock: true, shockCd: 5.2, shockTicks: 6, shockRadiusMult: 1.7 },
    { damage: 18, radius: 205, burn: true, burnDps: 16, shock: true, shockCd: 3, shockTicks: 6,
