...
export const CARD = {
  ...
  levels: [
    ...
    { damage: 15, radius: 115, burn: true, burnDps: 16, shock: true, shockCd: 5.2, shockTicks: 6, shockRadiusMult: 1.7 },
    { damage: 18, radius: 128, burn: true, burnDps: 16, shock: true, shockCd: 3, shockTicks: 6,
