...
export const CARD = {
  ...
  levels: [
    { damage: 8, radius: 40, life: 3.5, dropInterval: 0.22 },
    { damage: 11, radius: 44, life: 4.5, dropInterval: 0.22, burn: true, burnDps: 12 },
    { damage: 15, radius: 48, life: 5.5, dropInterval: 0.18, burn: true, burnDps: 14 },
    { damage: 18, radius: 52, life: 7.0, dropInterval: 0.18, burn: true, burnDps: 14, furnace: true, furnaceLife: 6 },
    { damage: 23, radius: 57, life: 8.5, dropInterval: 0.18, burn: true, burnDps: 14, furnace: true, enhancedFurnace: true, furnaceLife: 7.5 },
    { damage: 29, radius: 62, life: 10.0, dropInterval: 0.18, burn: true, burnDps: 14, furnace: true, enhancedFurnace: true, nineTurn: true, furnaceLife: 9, hotZoneLife: 5 },
  ],
