...
const UI_TEXTURES: Dictionary = {
  'panelCorner': preload('res://assets/ui/ornaments/panel_corner.png'),
  'divider': preload('res://assets/ui/ornaments/divider_blossom.png'),
  'buttonCrest': preload('res://assets/ui/ornaments/button_crest.png'),
  'focusCursor': preload('res://assets/ui/ornaments/focus_cursor.png'),
  'sealWeapon': preload('res://assets/ui/ornaments/seal_weapon.png'),
  'sealAttribute': preload('res://assets/ui/ornaments/seal_attribute.png'),
  'sealBlessing': preload('res://assets/ui/ornaments/seal_blessing.png'),
  'sealTask': preload('res://assets/ui/ornaments/seal_task.png'),
  'boss': preload('res://assets/ui/ornaments/medallion_boss.png'),
  'shop': preload('res://assets/ui/ornaments/medallion_shop.png'),
  'warehouse': preload('res://assets/ui/ornaments/medallion_warehouse.png'),
  'pause': preload('res://assets/ui/ornaments/medallion_pause.png'),
}
