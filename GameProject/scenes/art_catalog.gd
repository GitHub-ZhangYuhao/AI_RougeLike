...
const UI_TEXTURES: Dictionary = {
  'brandMascot': preload('res://assets/ui/modern/brand_mascot.svg'),
  'panelCorner': preload('res://assets/ui/modern/panel_corner.svg'),
  'divider': preload('res://assets/ui/modern/divider_blossom.svg'),
  'buttonCrest': preload('res://assets/ui/modern/button_crest.svg'),
  'focusCursor': preload('res://assets/ui/modern/focus_cursor.svg'),
  'sealWeapon': preload('res://assets/ui/modern/seal_weapon.svg'),
  'sealAttribute': preload('res://assets/ui/modern/seal_attribute.svg'),
  'sealBlessing': preload('res://assets/ui/modern/seal_blessing.svg'),
  'sealTask': preload('res://assets/ui/modern/seal_task.svg'),
  'boss': preload('res://assets/ui/modern/medallion_boss.svg'),
  'shop': preload('res://assets/ui/modern/medallion_shop.svg'),
  'warehouse': preload('res://assets/ui/modern/medallion_warehouse.svg'),
  'pause': preload('res://assets/ui/modern/medallion_pause.svg'),
}
