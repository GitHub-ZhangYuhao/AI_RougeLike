...
| 2026-08-20 | M6 | 抖音小游戏包体达标：slim 档收紧 env 长边 512→384（12 张环境贴图 512²→384²），slim 总包 20.69→19.37MB、pck 14.31→13.00MB（ctex 11.55→10.24MB），微信/抖音两端均无需 CDN；UI 与角色贴图未动，slim pck 运行时验证零脚本错误，双 smoke 459 项 / 26 场景全绿，发布清单同步复核注记 | （本次提交） |
