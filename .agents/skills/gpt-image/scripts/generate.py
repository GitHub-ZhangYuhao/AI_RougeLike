...
_MODEL_ENV = "GPT_IMAGE_MODEL"


def _load_skill_env() -> None:
    """Load relay credentials/configuration from this skill's .env file."""
    try:
...
def _apply_configured_model() -> None:
    """Use GPT_IMAGE_MODEL unless the caller supplied --model explicitly."""
    args = sys.argv[1:]
